...
export default function(name) {
	window.GLOBAL = {
		...
		deviceSet() {
			let _t = this;
			_t.domLoad(function(){
				document.getElementById('l-contentsBody').classList.add(_t.DEVICE);
				document.getElementById('l-contentsBody').classList.add(_t.OS);
				document.getElementById('l-contentsBody').classList.add(_t.BROWSER);
				document.getElementById('l-contentsBody').classList.add(_t.UA);
			})
		},
		domLoad(cb) {
			let _t = this;
